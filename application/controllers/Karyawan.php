...
class Karyawan extends CI_Controller{
    ...
    function tambah_aksi() {
        ...
        $this->Karyawan_model->input_data($data,'tabel_12210924');
    ...
    function edit ($id) {
        $where = array('id' => $id);
        $data['karyawan'] = $this->Karyawan_model->edit_data($where,'tabel_12210924')->result();
        $data['status'] = ['Menikah','Belum Menikah'];
        $data['jabatan'] = ['Direktur','Manager','Staff'];
    ...
    function update() {
        ...
        $this->Karyawan_model->update_data($where,$data,'tabel_12210924');
        redirect('karyawan/index');
    } 

    function hapus ($id) {
        $where = array('id' => $id);
        $this->Karyawan_model->hapus_data($where,'tabel_12210924');
        redirect('karyawan/index');
    }
}
